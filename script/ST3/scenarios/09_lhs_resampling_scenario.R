...
source(here::here("script", "ST3", "scenarios", "01_preprocessData_scenario.R"))
...
if (scenario == 1){
  parset <- rio::import(here::here("results", "ST3", "lhs_parset_projection.csv"))
  
} else if (scenario == 2){
  parset <- rio::import(here::here("results", "ST3", "lhs_parset_project_efficacy.csv"))
  
} else if (scenario == 3){
  parset <- rio::import(here::here("results", "ST3", "lhs_parset_project_duration.csv"))
  
} else if (scenario == 4){
  parset <- rio::import(here::here("results", "ST3", "lhs_parset_project_competition.csv"))
  
} else if (scenario == 5){
  parset <- rio::import(here::here("results", "ST3", "lhs_parset_modefit_efficacy.csv"))
  
} else if (scenario == 6){
  parset <- rio::import(here::here("results", "ST3", "lhs_parset_modefit_duration.csv"))
  
} else if (scenario == 7){
  parset <- rio::import(here::here("results", "ST3", "lhs_parset_modefit_competition.csv"))
...
if (scenario == 1){
  pred_traj <- base::readRDS(here::here("results", "ST3", "saved_ipdRun_projection.rds"))
  
} else if (scenario == 2){
  pred_traj <- base::readRDS(here::here("results", "ST3", "saved_ipdRun_project_efficacy.rds"))
  
} else if (scenario == 3){
  pred_traj <- base::readRDS(here::here("results", "ST3", "saved_ipdRun_project_duration..rds"))
  
} else if (scenario == 4){
  pred_traj <- base::readRDS(here::here("results", "ST3", "saved_ipdRun_project_competition.rds"))
  
} else if (scenario == 5){
  pred_traj <- base::readRDS(here::here("results", "ST3", "saved_ipdRun_modefit_efficacy.rds"))
  
} else if (scenario == 6){
  pred_traj <- base::readRDS(here::here("results", "ST3", "saved_ipdRun_modefit_duration.rds"))
  
} else if (scenario == 7){
  pred_traj <- base::readRDS(here::here("results", "ST3", "saved_ipdRun_modefit_competition.rds"))
...
if (scenario == 5) { #model fit of reduced efficacy
  rio::export(data_frame(data.frame(XX$GOF_cases)), here::here("results", "ST3", "logLik_efficacy.csv"))
  
} else if (scenario == 6){
  rio::export(data_frame(data.frame(XX$GOF_cases)), here::here("results", "ST3", "logLik_duration.csv"))
  
} else if (scenario == 7){
  rio::export(data_frame(data.frame(XX$GOF_cases)), here::here("results", "ST3", "logLik_competition.csv"))
...
if (scenario == 1){
  rio::export(posteriorEst, file = here("output", "ST3", "estimates_projection.csv"))
  
} else if (scenario == 2){
  rio::export(posteriorEst, file = here("output", "ST3", "estimates_project_efficacy.csv"))
  
} else if (scenario == 3){
  rio::export(posteriorEst, file = here("output", "ST3", "estimates_project_duration.csv"))
  
} else if (scenario == 4){
  rio::export(posteriorEst, file = here("output", "ST3", "estimates_project_competition.csv"))
  
} else if (scenario == 5){
  rio::export(posteriorEst, file = here("output", "ST3", "estimates_modefit_efficacy.csv"))
  
} else if (scenario == 6){
  rio::export(posteriorEst, file = here("output", "ST3", "estimates_modefit_duration.csv"))
  
} else if (scenario == 7){
  rio::export(posteriorEst, file = here("output", "ST3", "estimates_modefit_competition.csv"))
...
#save all plots
if (scenario == 1){
  ggsave(here::here("output", "ST3", "projections.png"), plot = post_trajPlot, width = 20, height = 10, unit = "in", dpi = 300)
  
} else if (scenario == 2){
  ggsave(here::here("output", "ST3", "project_efficacy.png"), plot = post_trajPlot, width = 20, height = 10, unit = "in", dpi = 300)
  
} else if (scenario == 3){
  ggsave(here::here("output", "ST3", "project_duration.png"), plot = post_trajPlot, width = 20, height = 10, unit = "in", dpi = 300)
  
} else if (scenario == 4){
  ggsave(here::here("output", "ST3", "project_competition.png"), plot = post_trajPlot, width = 20, height = 10, unit = "in", dpi = 300)
  
} else if (scenario == 5){
  ggsave(here::here("output", "ST3", "modefit_efficacy.png"), plot = post_trajPlot, width = 20, height = 10, unit = "in", dpi = 300)
  
} else if (scenario == 6){
  ggsave(here::here("output", "ST3", "modefit_duration.png"), plot = post_trajPlot, width = 20, height = 10, unit = "in", dpi = 300)
  
} else if (scenario == 7){
  ggsave(here::here("output", "ST3", "modefit_competition.png"), plot = post_trajPlot, width = 20, height = 10, unit = "in", dpi = 300)
...
if (scenario == 5){
  rio::export(posteriorDS, here::here('results', 'ST3', 'modefit_efficacy_plotF.csv'))

} else if (scenario == 6){
  rio::export(posteriorDS, here::here('results', 'ST3', 'modefit_duration_plotF.csv'))

} else if (scenario == 7){
  rio::export(posteriorDS, here::here('results', 'ST3', 'modefit_competition_plotF.csv'))
...
plotF <-
  dplyr::bind_rows(rio::import(here::here('results', 'ST3', 'modefit_efficacy_plotF.csv')) %>% dplyr::mutate(strat = 'H1: Reduced direct effectiveness'),
                   rio::import(here::here('results', 'ST3', 'modefit_duration_plotF.csv')) %>% dplyr::mutate(strat = 'H2: Reduced duration of protection'),
                   rio::import(here::here('results', 'ST3', 'modefit_competition_plotF.csv')) %>% dplyr::mutate(strat = 'H3: Reduced co-colonisation risk')) %>%
  dplyr::filter(stg == 'F') %>%
...
ggsave(here::here("output", "ST3", "sensitivity_st3_asV_T.png"), 
       plot = sensitivity_st3, 
       width = 20, 
       height = 10, 
       unit = "in", 
       dpi = 300)
...
Model_logLik <-
  dplyr::bind_cols(
    logLik_efficacy <- rio::import(here::here('results', "ST3", 'logLik_efficacy.csv')) %>% dplyr::rename('ll_efficacy' = 'XX.GOF_cases'),
    logLik_duration <- rio::import(here::here('results', "ST3", 'logLik_duration.csv'))  %>% dplyr::rename('ll_duration' = 'XX.GOF_cases'),
    logLik_competition <- rio::import(here::here('results', "ST3", 'logLik_competition.csv'))  %>% dplyr::rename('ll_competition' = 'XX.GOF_cases')) %>%
