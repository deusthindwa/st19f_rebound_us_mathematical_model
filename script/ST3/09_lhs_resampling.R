...
#extract parameters
parset <- rio::import(here::here("results", "ST3", "lhs_parset.csv"))
delta1 <- parset$V1
delta2 <- parset$V2
omega1 <- parset$V3
omega2 <- parset$V4
...
pred_traj <- readRDS(here::here("results", "ST3", "saved_ipd_dynamics.rds"))
...
rio::export(posteriorEst, file = here("output", "ST3", "baseModel_estimates.csv"))
...
ggsave(here::here("output", "ST3", "baseModel_obsfit.png"),
       plot = post_trajPlot,
