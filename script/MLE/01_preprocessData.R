...
ccr <-
  dplyr::bind_cols(
    ...
    data_frame(name2 = c('V_gp1', 'V_gp2', 'V_gp3', 'V_gp4', 'F_gp1', 'F_gp2', 'F_gp3', 'F_gp4', 'N_gp1', 'N_gp2', 'N_gp3', 'N_gp4'),
               value2 = c(383621.1, 1903534.5, 6093608.5, 36325375.6, 383621.1, 1903534.5,  6093608.5, 36325375.6, 383621.1, 1903534.5, 6093608.5, 36325375.6))) %>%
...
#Epistorm
# contact_US <-
#   as.matrix(rbind(c(0.35191855, 1.5087614, 1.095465, 3.958335),
#                   c(0.35191855, 1.5087614, 1.095465, 3.958335),
#                   c(0.04039284, 0.1731740, 4.581778, 4.792925),
#                   c(0.04835139, 0.2072943, 1.006943, 5.701542))
#                   )
