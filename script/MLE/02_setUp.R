...
obs_pop_1999_2009 <- rio::import(here::here('data', 'IPD', 'obs_pop_1999_2009.csv'))
obs_pop_2010_2019 <- rio::import(here::here('data', 'IPD', 'obs_pop_2010_2019.csv'))
obs_pop_1999_2019 <- rio::import(here::here('data', 'IPD', 'obs_pop_1999_2019.csv'))
...
StateNames <- c('S', 'V', 'F', 'N', 'NV', 'NF', 'VF', 'Sx', 'Vx', 'Fx', 'Nx', 'NVx', 'NFx', 'VFx')
