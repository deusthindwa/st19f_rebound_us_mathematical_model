...
#load R packages
source(here::here("script", "scenarios", "00_main_scenario.R"))
...
source(here::here("script", "scenarios", "02_setUp_scenario.R"))

#set up fixed parameter values
source(here::here("script", "scenarios", "03_modelParKnown_scenario.R"))

#run model function
source(here::here("script", "scenarios", "04_transModel_scenario.R"))

#call appropriate latin hypercube samples
#scenario=1, model projections based on estimated values pre-pcv13
#scenario=2, model simulation of reduced pcv13 VE against F acquisition
#scenario=3, model simulation of reduced pcv13 duration of protection against F carriage
#scenario=4, model simulation of reduced susceptibility of F to superinfection
...
scenario = vcase
source(here::here("script", "scenarios", "05_lhs_paraspace_scenario.R"))
...
for( nn in 1:len_each_run){
  ...
  source(here::here("script", "scenarios", "06_lhs_model_scenario.R"))
...
if (scenario == 1){
  rio::export(saved_ipd_modelRun, here::here("results", "saved_ipdRun_projection.rds"))
  
} else if (scenario == 2){
  rio::export(saved_ipd_modelRun, here::here("results", "saved_ipdRun_project_efficacy.rds"))
  
} else if (scenario == 3){
  rio::export(saved_ipd_modelRun, here::here("results", "saved_ipdRun_project_duration..rds"))
  
} else if (scenario == 4){
  rio::export(saved_ipd_modelRun, here::here("results", "saved_ipdRun_project_competition.rds"))
  
} else if (scenario == 5){
  rio::export(saved_ipd_modelRun, here::here("results", "saved_ipdRun_modefit_efficacy.rds"))
  
} else if (scenario == 6){
  rio::export(saved_ipd_modelRun, here::here("results", "saved_ipdRun_modefit_duration.rds"))
  
} else if (scenario == 7){
  rio::export(saved_ipd_modelRun, here::here("results", "saved_ipdRun_modefit_competition.rds"))
  
} else if (scenario == 8){
  rio::export(saved_ipd_modelRun, here::here("results", "saved_ipdRun_project_efficacy_reduced.rds"))
  
} else if (scenario == 9){
  rio::export(saved_ipd_modelRun, here::here("results", "saved_ipdRun_project_efficacy_constant.rds"))
  
} else if (scenario == 10){
  rio::export(saved_ipd_modelRun, here::here("results", "saved_ipdRun_project_pcv7serotypes.rds"))
