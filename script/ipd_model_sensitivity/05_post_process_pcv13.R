...
process_scenario <- function(scenario_id, estimated_par_name, prior_overlay) { 
  ...
  fit_file <- here::here('results', 'ipd_model_sensitivity', sprintf("ipd_fit_scenario%d.rds", scenario_id))
  inputs_file <- here::here('results', 'ipd_model_sensitivity', sprintf("ipd_fit_inputs_scenario%d.rds", scenario_id))
  ...
  rio::export(post_pairs, here::here('results', 'ipd_model_sensitivity', sprintf("%s_pairs_plot.csv", prefix)))
  ...
  rio::export(obs_pred, here::here('results', 'ipd_model_sensitivity', sprintf("%s_obs_pred_plot.csv", prefix)))
  ggsave(here::here('output', 'ipd_model_sensitivity', sprintf("%s_obs_pred_plot.png", prefix)), p_obs_pred, width = 20, height = 12, dpi = 330)
  ...
  rio::export(prev_pcv13, here::here('results', 'ipd_model_sensitivity', sprintf("%s_carriage_prevalence_plot.csv", prefix)))
  ggsave(here::here('output', 'ipd_model_sensitivity', sprintf("%s_carriage_prevalence_plot.png", prefix)), p_prev, width = 14, height = 8, dpi = 150)
...
density_ds <-
  dplyr::bind_rows(
  rio::import(here::here('results', 'ipd_model_sensitivity', 'scenario1_pairs_plot.csv')) %>% dplyr::mutate(scenario = "Reduced direct PCV effectiveness") %>% dplyr::rename('value' = 'delta_F_13'),
  rio::import(here::here('results', 'ipd_model_sensitivity', 'scenario2_pairs_plot.csv')) %>% dplyr::mutate(scenario = "Reduced duration of PCV protection") %>% dplyr::rename('value' = 'omega_F_13'),
  rio::import(here::here('results', 'ipd_model_sensitivity', 'scenario3_pairs_plot.csv')) %>% dplyr::mutate(scenario = "Increased risk of N to co-colonisation") %>% dplyr::rename('value' = 'rr_V')) %>%
...
dplyr::bind_rows(
  rio::import(here::here('results', 'ipd_model_sensitivity', 'scenario1_obs_pred_plot.csv')) %>% dplyr::mutate(scenario = "Reduced direct PCV effectiveness"),
  rio::import(here::here('results', 'ipd_model_sensitivity', 'scenario2_obs_pred_plot.csv')) %>% dplyr::mutate(scenario = "Reduced duration of PCV protection"),
  rio::import(here::here('results', 'ipd_model_sensitivity', 'scenario3_obs_pred_plot.csv')) %>% dplyr::mutate(scenario = "Increased risk of N to co-colonisation")) %>%
  dplyr::mutate(scenario = factor(scenario, levels = c("Reduced direct PCV effectiveness", "Reduced duration of PCV protection", "Increased risk of N to co-colonisation"))) %>%
...
scenarios_prev <- 
  dplyr::bind_rows(
    rio::import(here::here('results', 'ipd_model_sensitivity', 'scenario1_carriage_prevalence_plot.csv')) %>% dplyr::mutate(scenario = "Reduced direct PCV effectiveness"),
    rio::import(here::here('results', 'ipd_model_sensitivity', 'scenario2_carriage_prevalence_plot.csv')) %>% dplyr::mutate(scenario = "Reduced duration of PCV protection"),
    rio::import(here::here('results', 'ipd_model_sensitivity', 'scenario3_carriage_prevalence_plot.csv')) %>% dplyr::mutate(scenario = "Increased risk of N to co-colonisation")) %>%
  dplyr::mutate(scenario = factor(scenario, levels = c("Reduced direct PCV effectiveness", "Reduced duration of PCV protection", "Increased risk of N to co-colonisation")))
