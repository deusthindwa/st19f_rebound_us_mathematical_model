...
obs_ipd <- tibble::tribble(
  ...
  2010,   131,   85,   60, 1071,    1,    1,    1,   26,   99,   65,   45, 1868, #EXCEPTIONAL: the number for F_3 cases in 2010 was 0 but replaced it with 1 so that CCRs are well defined for 2010-2019
  2011,    29,   32,   44,  803,    3,    1,    2,   20,  118,   59,   50, 2047,
  2012,    12,   13,   30,  448,    1,    2,    5,   32,   95,   57,   60, 2018,
  2013,     5,   12,   17,  345,    2,    0,    5,   37,   97,   64,   58, 2332,
  2014,     9,    9,    7,  247,    4,    4,    1,   41,   80,   61,   62, 2024,
  2015,     7,    5,    7,  200,    7,    3,    4,   62,   94,   45,   50, 2129,
  2016,     8,    2,   14,  196,    5,    6,    6,   74,   77,   47,   50, 2254,
  2017,     2,    9,   11,  222,    5,    4,   11,   72,   65,   43,   62, 2430,
  2018,     2,    2,    7,  234,    5,    3,   11,   72,   76,   45,   65, 2399,
  2019,     2,    4,    6,  181,    9,    2,    3,   88,   75,   45,   57, 2379
)
