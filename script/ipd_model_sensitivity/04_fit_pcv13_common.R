...
#joint-posteriro MVN propagation
#priors with two multivariate-normal priors on the log scale. This preserves every pairwise correlation from the source posteriors:
...
#HMC leapfrog moves during early warmup can push unconstrained log_carr / log_ipd far past reasonable values, causing exp() to overflow in the ODE call
#bounds at +-10 marginal SDs are ~15 orders of magnitude past the MVN prior mass and prevent overflow.
