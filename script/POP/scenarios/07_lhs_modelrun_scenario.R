...
#load R packages
source(here::here("script", "POP", "scenarios", "00_main_scenario.R"))
...
source(here::here("script", "POP", "scenarios", "02_setUp_scenario.R"))

#set up fixed parameter values
source(here::here("script", "POP", "scenarios", "03_modelParKnown_scenario.R"))

#run model function
source(here::here("script", "POP", "scenarios", "04_transModel_scenario.R"))
...
scenario = vcase
source(here::here("script", "POP", "scenarios", "05_lhs_paraspace_scenario.R"))
...
for( nn in 1:len_each_run){
  ...
  source(here::here("script", "POP", "scenarios", "06_lhs_model_scenario.R"))
...
if (scenario == 1){
  rio::export(saved_ipd_modelRun, here::here("results", "POP", "saved_ipdRun_projection.rds"))
  
} else if (scenario == 2){
  rio::export(saved_ipd_modelRun, here::here("results", "POP", "saved_ipdRun_project_efficacy.rds"))
  
} else if (scenario == 3){
  rio::export(saved_ipd_modelRun, here::here("results", "POP", "saved_ipdRun_project_duration..rds"))
  
} else if (scenario == 4){
  rio::export(saved_ipd_modelRun, here::here("results", "POP", "saved_ipdRun_project_competition.rds"))
  
} else if (scenario == 5){
  rio::export(saved_ipd_modelRun, here::here("results", "POP", "saved_ipdRun_modefit_efficacy.rds"))
  
} else if (scenario == 6){
  rio::export(saved_ipd_modelRun, here::here("results", "POP", "saved_ipdRun_modefit_duration.rds"))
  
} else if (scenario == 7){
  rio::export(saved_ipd_modelRun, here::here("results", "POP", "saved_ipdRun_modefit_competition.rds"))
