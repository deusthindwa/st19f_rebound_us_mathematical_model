...
#extract parameters
parset <- rio::import(here::here("results", "POP", "lhs_parset.csv"))
delta1 <- parset$V1
delta2 <- parset$V2
omega1 <- parset$V3
omega2 <- parset$V4
...
pred_traj <- readRDS(here::here("results", "POP", "saved_ipd_dynamics.rds"))
...
rio::export(posteriorEst, file = here("output", "POP", "baseModel_estimates.csv"))
...
ggsave(here::here("output", "POP", "baseModel_obsfit.png"),
       plot = post_trajPlot,
