...
#load R packages
source(here::here("script", "POP", "00_main.R"))

#load data to fit model to
source(here::here("script", "POP", "01_preprocessData.R"))

#set up model including births, contacts, population
source(here::here("script", "POP", "02_setUp.R"))

#set up fixed parameter values
source(here::here("script", "POP", "03_modelParKnown.R"))

#run model function
source(here::here("script", "POP", "04_transModel.R"))

#call latin hypercube samples
source(here::here("script", "POP", "05_lhs_paraspace.R"))
...
for( nn in 1:len_each_run){
  ...
  source(here::here("script", "POP", "06_lhs_model.R"))
...
rio::export(saved_ipd_dynamics, here::here("results", "POP", "saved_ipd_dynamics.rds"))
